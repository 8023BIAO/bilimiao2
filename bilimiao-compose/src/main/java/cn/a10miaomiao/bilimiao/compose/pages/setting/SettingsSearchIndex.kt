...
object SettingsSearchIndex {
    ...
    val items: List<SettingSearchItem> = listOf(
        ...
        SettingSearchItem("VideoMinDuration", "video_min_duration", "最小视频时长过滤", "③ 内容与评论", SettingSearchItem.Kind.INT, SettingConstants.VIDEO_MIN_DURATION_DEFAULT, "最小视频时长过滤 ③ 内容与评论 视频 内容"),
        SettingSearchItem("VideoMinPlayCount", "video_min_play_count", "最小播放量过滤", "③ 内容与评论", SettingSearchItem.Kind.INT, SettingConstants.VIDEO_MIN_PLAY_COUNT_DEFAULT, "最小播放量过滤 ③ 内容与评论 视频 内容"),
