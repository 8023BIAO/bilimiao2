...
import cn.a10miaomiao.bilimiao.compose.assets.bilimiaoicons.common.Bilidownload
...
public val CommonGroup.AllIcons: ____KtList<ImageVector>
  get() {
    ...
    __AllIcons= listOf(Bilicoin, Bilifavourite, Bililike, Bilishare, Bilidownload, Danmukunum, Delete, Like,
