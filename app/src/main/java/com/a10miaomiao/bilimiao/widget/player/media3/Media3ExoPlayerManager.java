...
public class Media3ExoPlayerManager extends BasePlayerManager {
    ...
    protected ExoMediaPlayer buildMediaPlayer(Context context) {
        ...
        // DASH 缓冲裁减：默认 50s → 可配置，避免高码率 OOM
        // 0=系统默认(50s)，其他=指定秒数
        int minBufferMs = dashBufferSec > 0 ? dashBufferSec * 1000 : 50000;
        int maxBufferMs = dashBufferSec > 0 ? dashBufferSec * 2000 : 50000;
        DefaultLoadControl loadControl = new DefaultLoadControl.Builder()
                .setBufferDurationsMs(
                        minBufferMs,   // minBufferMs
                        maxBufferMs,   // maxBufferMs (2x min)
