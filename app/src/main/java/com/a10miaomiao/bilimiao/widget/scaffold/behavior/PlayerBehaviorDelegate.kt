...
class PlayerBehaviorDelegate(
    ...
    private val dragger = ViewDragHelper.create(parent, 0.8f, this)
    ...
    fun holdUpTop() {
        ...
        // 动画起点x,y坐标
        val originX = playerView.x.toInt() + (originWidth - playerWidth) / 2
                ...
                MotionEvent.ACTION_DOWN -> {
                    ...
                    if(startX > playerView.x - dragWidth
                        ...
                        if (startY > playerView.y + playerHeight - dragWidth) {
                            ...
                            //顶部拖拽条，排除左侧返回按钮(48dp)和右侧挂起按钮
                            val backButtonWidth = parent.dip(48)
                            if (startX < playerView.x + backButtonWidth
                                || startX > playerView.x + playerWidth - holdButtonWidth
                            ) {
                                return false
                            }
