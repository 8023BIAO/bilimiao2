        ...
        new Handler(Looper.myLooper()).post(
                new Runnable() {
                    ...
                    public void run() {
                        ...
                        // DASH 码率上限在 DashSource 层面已过滤，TrackSelector 不再重复限制
                        // （避免 TrackSelector 的 bitrate 计算方式与 DashSource 不一致导致轨道被意外过滤）
                        ...
                        // 传给 PlaybackService 用于后台播放通知 + 进度条
                        com.a10miaomiao.bilimiao.service.PlaybackService playbackInstance =
                                com.a10miaomiao.bilimiao.service.PlaybackService.Companion.getInstance();
