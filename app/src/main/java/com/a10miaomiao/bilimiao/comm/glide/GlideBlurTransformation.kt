...
class GlideBlurTransformation(
    ...
    companion object {
        private val ID_BYTES = "GlideBlurTransformation".toByteArray()
    }
    ...
    override fun updateDiskCacheKey(messageDigest: MessageDigest) {
        ...
        blurRadius.toBits().let { messageDigest.update(it.toByte()); messageDigest.update((it shr 8).toByte()) }
    }
