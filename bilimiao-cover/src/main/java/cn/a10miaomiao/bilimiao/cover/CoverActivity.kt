...
class CoverActivity : AppCompatActivity() {
    ...
    private var cachedThemeMode: Int = 0
...
//        }
    ...
    private fun File.writeBitmap(data: Bitmap) {
        FileOutputStream(this).use { fOut ->
    ...
    private fun preloadThemeMode() {
        lifecycleScope.launch(Dispatchers.IO) {
            cachedThemeMode = SettingPreferences.mapData(this@CoverActivity) { prefs ->
